...
of these is [[https://ox-hugo.scripter.co/][=ox-hugo=]],[fn:2] which is built to work with the site generator Hugo. This
...
[fn:2] =ox-hugo= is designed for a slightly different workflow than mine, in which the
entire _site_ is in a single org file.
